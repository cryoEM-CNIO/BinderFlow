...
def main():
    ...
    parser.add_argument("--rfd_ndesigns", type=str, required=False, help="Number of designs.")
    parser.add_argument("--pmp_nseqs", type=str, help="Number of final designs.")
    ...
    parser.add_argument('--hits_number', type=str, required=False, help='Number of hits to design')
